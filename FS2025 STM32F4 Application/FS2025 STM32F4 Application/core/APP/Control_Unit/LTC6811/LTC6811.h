...
*/
void LTC6811_adcv(uint8_t n_ic,uint8_t MD, //!< ADC Conversion Mode
...
*/
void LTC6811_wrcfg(uint8_t n_ic, //!< The number of ICs being written
                   cell_asic* ic //!< a two dimensional array of the configuration data that will be written
                  );

void LTC6811_wrcfgb(uint8_t n_ic, //!< The number of ICs being written
                    cell_asic* ic //!< a two dimensional array of the configuration data that will be written
                   );
...
*/
int8_t LTC6811_rdcfg(uint8_t n_ic, //!< number of ICs in the daisy chain
                     cell_asic* ic //!< a two dimensional array that the function stores the read configuration data
                    );

int8_t LTC6811_rdcfgb(uint8_t n_ic, //!< number of ICs in the daisy chain
                      cell_asic* ic //!< a two dimensional array that the function stores the read configuration data
                     );
/*!  Write the LTC6811 PWM register
*/
void LTC6811_wrpwm(uint8_t n_ic, //!< number of ICs in the daisy chain
                   uint8_t pwmReg,
                   cell_asic* ic
                  );
...
*/
int8_t LTC6811_rdpwm(uint8_t n_ic, //!< number of ICs in the daisy chain
                     uint8_t pwmReg,
...
*/
void LTC6811_wrsctrl(uint8_t n_ic, //!< number of ICs in the daisy chain
                     uint8_t sctrl_reg,
                     cell_asic* ic
                    );
...
@return int8_t, PEC Status.
  ...
  -1: Data read back has incorrect PEC
*/
int8_t LTC6811_rdsctrl(uint8_t n_ic, //!< number of ICs in the daisy chain
                       uint8_t sctrl_reg,
                       cell_asic* ic //!< a two dimensional array that the function stores the read pwm data
                      );
...
*/
void LTC6811_wrcomm(uint8_t n_ic, //!< Number of ICs in the daisy chain
...
*/
int8_t LTC6811_rdcomm(uint8_t n_ic, //!< number of ICs in the daisy chain
...
uint16_t LTC6811_st_lookup(uint8_t n_ic,
  uint8_t MD, //!< ADC Conversion Mode
  uint8_t ST //!< Self test number
);

void LTC6811_set_discharge(uint8_t n_ic,int Cell,
                           cell_asic* ic);

/*! Helper function that runs the ADC Self Tests*/
int16_t LTC6811_run_cell_adc_st(uint8_t n_ic,uint8_t adc_reg,
                                cell_asic* ic);

/*! Helper function that runs the ADC Digital Redudancy commands and checks output for errors*/
int16_t LTC6811_run_adc_redundancy_st(uint8_t n_ic,uint8_t adc_mode,
                                      uint8_t adc_reg,
                                      cell_asic* ic);

/*! Helper function that runs the datasheet open wire algorithm*/
void LTC6811_run_openwire(uint8_t n_icc,
                          cell_asic* ic);
...
uint16_t LTC6811_run_adc_overlap(uint8_t n_ic,
                                 cell_asic* ic);
