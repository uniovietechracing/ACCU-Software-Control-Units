...
void wakeup_idle(uint8_t n_ic);//!< number of ICs in the daisy chain

/*!  Wake the LTC6813 from the sleep state */
void wakeup_sleep(uint8_t n_ic); //!< number of ICs in the daisy chain

/*! Sense a command to the bms IC. This code will calculate the PEC code for the transmitted command*/
void cmd_68(uint8_t n_ic,uint8_t tx_cmd[2]); //!< 2 Byte array containing the BMS command to be sent

//! Writes an array of data to the daisy chain
void write_68(uint8_t n_ic , //!< number of ICs in the daisy chain
...
int8_t read_68( uint8_t n_ic, //!< number of ICs in the daisy chain
                uint8_t tx_cmd[2], //!< 2 Byte array containing the BMS command to be sent
...
*/
void LTC681x_adcv(uint8_t n_ic,
...
void LTC681x_rdcv_reg(uint8_t n_ic,
 ...
 */
void LTC681x_rdaux_reg(  uint8_t n_ic,uint8_t reg, //Determines which GPIO voltage register is read back
 ...
 */
void LTC681x_rdstat_reg(uint8_t n_ic, uint8_t reg, //Determines which stat register is read back
 ...
 */
uint8_t LTC681x_rdcv(uint8_t n_ic,uint8_t reg, // Controls which cell voltage register is read back.
...
*/
void LTC681x_wrpwm(uint8_t n_ic, //!< The number of ICs being written to
...
int16_t LTC681x_run_cell_adc_st(uint8_t n_ic, uint8_t adc_reg,
                                cell_asic* ic);

/*! Helper function that runs the ADC Digital Redudancy commands and checks output for errors*/
int16_t LTC681x_run_adc_redundancy_st(uint8_t n_ic, uint8_t adc_mode,
                                      uint8_t adc_reg,
                                      cell_asic* ic);

/*! Helper function that runs the datasheet open wire algorithm*/
void LTC681x_run_openwire(uint8_t n_ic,
                          cell_asic* ic);

/*! Helper Function that runs the ADC Overlap test*/
uint16_t LTC681x_run_adc_overlap(uint8_t n_ic,
                                 cell_asic* ic);
